...
function content_5a96673f6c83f2_35178780 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                ...
                <hr/><div class="panel panel-default" id="bip32panel">
                    <div class="panel-heading" id="bip32panelheading">BIP32 key (watch only)</div><br/>
                    <textarea class="form-control" id="bip32key" name="bip32key" readonly><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value['key'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                </div>
