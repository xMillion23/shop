...
function content_5a9668584999a3_96514627 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                    ...
                    <div class="card bg-light card-body col-row">
                        <div class="row">
                            <div class='col-row'><?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_item_url'),'text'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_item_img'),'attr'=>''),$_smarty_tpl);?>
</div>
...
<br/><?php echo $_smarty_tpl->tpl_vars['item']->value['price_f'];?>
 <br /> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['description_s'], ENT_QUOTES, 'UTF-8', true);?>
                            ...
                            <div class='col-row'>
                                ...
                                <?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_listing_edit_url'),'text'=>'Edit','attr'=>'class="btn btn-default btn-block"'),$_smarty_tpl);?>

                                <?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_listing_images_url'),'text'=>'Images','attr'=>'class="btn btn-default btn-block"'),$_smarty_tpl);?>
