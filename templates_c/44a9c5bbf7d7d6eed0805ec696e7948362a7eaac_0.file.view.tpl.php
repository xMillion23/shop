...
function content_5a982c5d4244e9_18857511 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                    ...
                    <div class="col-row">
                        <div class="col-row">
                            <h2>
                            <?php if ($_smarty_tpl->tpl_vars['current_user']->value['logged_in'] == TRUE && $_smarty_tpl->tpl_vars['current_user']->value['user_id'] !== $_smarty_tpl->tpl_vars['user']->value['id']) {?>
                            <?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_message_user_url'),'text'=>"Message",'attr'=>'class="btn btn-default"'),$_smarty_tpl);?>

                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['current_user']->value['user_role'] == 'Admin' && $_smarty_tpl->tpl_vars['user']->value['user_role'] !== 'Admin') {?>
                            <?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_ban_user_page'),'text'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_ban_user_txt'),'attr'=>'class="btn btn-default"'),$_smarty_tpl);?>

                            <?php }?>
                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['user_name'], ENT_QUOTES, 'UTF-8', true);?>
 <?php if ($_smarty_tpl->tpl_vars['user']->value['banned'] == TRUE) {?><small>(banned)</small><?php }?></h2>
                        </div>
                    </div>
           </div>
