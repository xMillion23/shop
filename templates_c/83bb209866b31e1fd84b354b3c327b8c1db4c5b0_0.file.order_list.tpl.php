...
function content_5a966d64365f27_18596336 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
            <div class="container-fluid" id="my-orders">
                        ...
                        <div class="row">
                            ...
                            <div class="col w-75 mx-auto">
                                <div class="col w-75 mx-auto">
                                    ...
                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Vendor</strong></div>
                                        <div class="col w-75 mx-auto" style='word-wrap: break-word;'><?php echo smarty_function_url(array('type'=>'anchor','url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_vendor_url'),'text'=>htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['vendor']['user_name'], ENT_QUOTES, 'UTF-8', true),'attr'=>''),$_smarty_tpl);?>
</div>
                                    </div>
                                    <?php } else { ?>
                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Buyer</strong></div>
                                        <div class="col w-75 mx-auto" style='word-wrap: break-word;'><?php echo smarty_function_url(array('type'=>'anchor','url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_buyer_url'),'text'=>htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['buyer']['user_name'], ENT_QUOTES, 'UTF-8', true),'attr'=>''),$_smarty_tpl);?>
</div>
                                    </div>
                                    <?php }?>

                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Price</strong></div>
                                        <div class="col w-75 mx-auto"><?php echo $_smarty_tpl->tpl_vars['current_user']->value['currency']['symbol'];
echo $_smarty_tpl->tpl_vars['order']->value['price_l'];?>
</div>
                                    </div>

                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Updated</strong></div>
                                        <div class="col w-75 mx-auto"><?php echo $_smarty_tpl->tpl_vars['order']->value['time_f'];?>
</div>
                                    </div>
                                </div>

                                <div class="col w-75 mx-auto">
                                    <div class="col w-75 mx-auto"><strong>Items</strong></div>
                                    <div class="col w-75 mx-auto">
                                        <ul>
                                            <?php
...
?>
                            ...
                            <!-- Order Body -->
                            <div class="col w-75 mx-auto">
                                <div class="col w-75 mx-auto"><?php echo $_smarty_tpl->tpl_vars['order']->value['progress_message'];?>
</div>
                                <div class="col w-75 mx-auto">
                                    <div class="row bs-wizard" style="border-bottom:0;">
                                        <div class="col bs-wizard-step <?php if ($_smarty_tpl->tpl_vars['order']->value['progress'] > 1) {?>complete<?php } else { ?>active<?php }?>">
                                        ...
                                        <div class="col bs-wizard-step <?php if ($_smarty_tpl->tpl_vars['order']->value['progress'] > 2) {?>complete<?php } else { ?>disabled<?php }?>"><!-- complete -->
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['order']->value['refund_time'] !== '') {?>
                                            <div class="col bs-wizard-step <?php if ($_smarty_tpl->tpl_vars['order']->value['progress'] == 7) {?>complete<?php } else { ?>disabled<?php }?>">
                                        ...
                                        <?php } else { ?>
                                            <div class="col bs-wizard-step <?php if ($_smarty_tpl->tpl_vars['order']->value['progress'] > 4) {?>complete<?php } else { ?>disabled<?php }?>"><!-- complete -->
                                                <div class="text-center bs-wizard-stepnum">Step 3</div>
                                                <div class="progress"><div class="progress-bar"></div></div>
                                                <a href="#" class="bs-wizard-dot"></a>
                                            ...
                                            <div class="col bs-wizard-step <?php if ($_smarty_tpl->tpl_vars['order']->value['progress'] == 7) {?>complete<?php } else { ?>disabled<?php }?>"><!-- active -->
