<?php
/* Smarty version 3.1.30, created on 2018-02-28 03:45:24
  from "/var/www/html/shop/application/views/smarty_templates/items/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a966c246c07b6_78496999',
...
function content_5a966c246c07b6_78496999 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
            <div class="col-row">
                <blockquote class="blockquote text-center"><div class="row">
                    <div class="col-row">
...
echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_item_url'),'text'=>htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['name'], ENT_QUOTES, 'UTF-8', true),'attr'=>"title='".$_prefixVariable2."'"),$_smarty_tpl);?>
                                        ...
                                        <p><?php echo $_smarty_tpl->tpl_vars['item']->value['price_f'];?>
 - <?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_item_vendor_url'),'text'=>htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['vendor']['user_name'], ENT_QUOTES, 'UTF-8', true),'attr'=>''),$_smarty_tpl);?>
</p>
                                    </div>
                                    <div class="ratings">
                                        <p class="float-right"><?php echo smarty_function_url(array('type'=>"anchor",'url'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_reviews_url'),'text'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 't_reviews_str'),'attr'=>''),$_smarty_tpl);?>
</p>
