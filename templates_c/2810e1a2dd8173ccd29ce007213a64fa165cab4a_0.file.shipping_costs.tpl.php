...
function content_5a968b10f20796_31455927 (Smarty_Internal_Template $_smarty_tpl) {
...
" value="<?php echo $_smarty_tpl->tpl_vars['cost']->value['cost'];?>
" />
                                            </div>
                                        </div>
...
?>
                ...
                <hr/><div class='container'>
                        ...
                        <div class="form">
                            <label class="control-label col-row" for="add_price">Price - <?php echo $_smarty_tpl->tpl_vars['item']->value['currency']['code'];?>
</label>
                            <div class="col-row">
                                <div class="input-group">
                                    <span class="input-group-addon"><i><?php echo $_smarty_tpl->tpl_vars['item']->value['currency']['code'];?>
</i></span>
                                    <input type='text' name='add_price' class="form-control text-center" id="add_price" value="<?php if ($_smarty_tpl->tpl_vars['item']->value['currency']['id'] == '0') {?>0.0001<?php } else { ?>10<?php }?>"/>
                                </div>
                            </div>
