...
function content_5a9936b0279b78_74080236 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
 ...
 Address</label>
                    ...
                    <div class="col-row">
                        <div class="col-row">
                            <div class="text-warning"><?php echo smarty_function_form(array('method'=>"form_error",'field'=>"address"),$_smarty_tpl);?>
</div>
                        </div>
                    </div>
                </div><br/>
                ...
                <div class='form'>
                    ...
                    <div class="col-row">
                        <div class="col-row">
                            <div class="text-warning"><?php echo smarty_function_form(array('method'=>"form_error",'field'=>"password"),$_smarty_tpl);?>
</div>
                        </div>
                    </div>
                </div>
