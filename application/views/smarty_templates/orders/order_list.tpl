                ...
                {if $orders == TRUE}
                    {foreach from=$orders item=order}
                        ...
                        <div class="row">
                            ...
                            <div class="col w-75 mx-auto">
                                <div class="col w-75 mx-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col w-75 mx-auto" style='word-wrap: break-word;'>{url type='anchor' url=$smarty.capture.t_vendor_url text=$order.vendor.user_name|escape:"html":"UTF-8" attr=''}</div>
                                    </div>
                                    {else}
                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Buyer</strong></div>
                                        <div class="col w-75 mx-auto" style='word-wrap: break-word;'>{url type='anchor' url=$smarty.capture.t_buyer_url text=$order.buyer.user_name|escape:"html":"UTF-8" attr=''}</div>
                                    </div>
                                    {/if}

                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Price</strong></div>
                                        <div class="col w-75 mx-auto">{$current_user.currency.symbol}{$order.price_l}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col w-75 mx-auto"><strong>Updated</strong></div>
                                        <div class="col w-75 mx-auto">{$order.time_f}</div>
                                    </div>
                                </div>
                            ...
                            <!-- Order Body -->
                            <div class="col w-75 mx-auto">
                                <div class="col w-75 mx-auto">{$order.progress_message}</div>
                                <div class="col w-75 mx-auto">
                                    <div class="row bs-wizard" style="border-bottom:0;">
                                        <div class="col bs-wizard-step {if $order.progress > 1}complete{else}active{/if}">
                                        ...
                                        <div class="col bs-wizard-step {if $order.progress > 2}complete{else}disabled{/if}"><!-- complete -->
                                        ...
                                        {if $order.refund_time !== ''}
                                            <div class="col bs-wizard-step {if $order.progress == 7}complete{else}disabled{/if}">
                                        ...
                                        {else}
                                            <div class="col bs-wizard-step {if $order.progress > 4}complete{else}disabled{/if}"><!-- complete -->
                                                <div class="text-center bs-wizard-stepnum">Step 3</div>
                                                <div class="progress"><div class="progress-bar"></div></div>
                                                <a href="#" class="bs-wizard-dot"></a>
                                            ...
                                            <div class="col bs-wizard-step {if $order.progress == 7}complete{else}disabled{/if}"><!-- active -->
