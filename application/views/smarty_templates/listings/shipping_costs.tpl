        ...
        {capture name='t_alter_form_errors'}{form method="validation_errors"}{/capture}
            ...
            <div class="col-row">
                                    ...
                                    <div class="col-row">
                                        ...
                                        <div class="col-row">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class='form-control text-center' name="{$smarty.capture.t_cost_field}" value="{$cost.cost}" />
                                            </div>
                                        </div>
                ...
                <hr/><div class='container'>
                        ...
                        <div class="form">
                            <label class="control-label col-row" for="add_price">Price - {$item.currency.code}</label>
                            <div class="col-row">
                                <div class="input-group">
                                    <span class="input-group-addon"><i>{$item.currency.code}</i></span>
                                    <input type='text' name='add_price' class="form-control text-center" id="add_price" value="{if $item.currency.id == '0'}0.0001{else}10{/if}"/>
                                </div>
                            </div>
